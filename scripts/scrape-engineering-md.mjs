/**
 * Scrape Feishu frontend engineering interview docx into content/engineering/
 * Source: https://w0hog67yl81.feishu.cn/wiki/WETYwNubfio3D3k8Q1Lcj8hgn1l
 */
...
const outDir = path.join(root, 'content', 'engineering')
const WIKI_TOKEN = 'WETYwNubfio3D3k8Q1Lcj8hgn1l'
const DOC_TOKEN = 'VgVwdD9jToeuoExE7Sbcl8Xsngg'
const SOURCE = `https://w0hog67yl81.feishu.cn/wiki/${WIKI_TOKEN}`
const MODULE_ID = 'engineering'
...
async function main() {
  ...
  console.log('open engineering wiki doc…')
...
`
  ...
  mod.title = `前端工程化（${docsMeta.length}）`
  mod.docs = [
  ...
  await fs.writeFile(
    path.join(root, 'scripts', 'engineering-feishu-map.json'),
