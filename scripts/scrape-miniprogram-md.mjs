/**
 * Scrape Feishu miniprogram interview docx into content/miniprogram/
 * Source: https://w0hog67yl81.feishu.cn/wiki/QwmHwAqJYiktztkd3S9cRpQUn5r
 */
...
const outDir = path.join(root, 'content', 'miniprogram')
const WIKI_TOKEN = 'QwmHwAqJYiktztkd3S9cRpQUn5r'
const DOC_TOKEN = 'W5ardMcPKokn4PxjLbJcQJRMnQg'
const SOURCE = `https://w0hog67yl81.feishu.cn/wiki/${WIKI_TOKEN}`
const MODULE_ID = 'miniprogram'
...
async function main() {
  ...
  console.log('open miniprogram wiki doc…')
...
`
  ...
  await fs.writeFile(
    path.join(root, 'scripts', 'miniprogram-feishu-map.json'),
