...
> 来源：[飞书原文](https://my.feishu.cn/docx/H4ejdDoYGoTulyxFFPoctqaDnfh)
...
reactive 用于创建对象的响应式代理，它会深度地遍历对象所有属性，将其转换为 Proxy。与 ref 不同，reactive 返回的代理对象可以直接访问和修改其属性，无需 .value。
