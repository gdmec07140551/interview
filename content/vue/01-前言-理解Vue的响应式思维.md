...
> 来源：[飞书原文](https://my.feishu.cn/docx/Pc0UdFVNZoUgTKxYFqJc48JInjg)
...
而在于你能否用响应式的思维方式去分析和解决问题——让面试官相信你能用Vue写出优雅、高效的代码。

很多人学 Vue，最先掌握的是各种 API 的用法，比如 ref、reactive、watch、v-model 等。

但真正拉开差距的，不在于谁背得多，而在于能不能把这些工具用得合适。
...
所以我做了这份资料包，帮你建立系统的Vue知识体系和响应式思维模式。
...
这不是一份让你死记硬背的API文档，而是一套帮助你建立Vue响应式思维、掌握核心原理、提升表达能力的完整学习资料包。
...
不只是学会ref、reactive、computed、watch的基本用法，更要理解：
