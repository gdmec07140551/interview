...
> 来源：[飞书原文](https://w0hog67yl81.feishu.cn/wiki/IRM4wK4Jgieak3kNFEqc2cuCnFb)  
> 章节：一、渲染流程与性能优化
...
- 重绘 (Repaint): 当元素的视觉样式（如color, background-color）发生改变，但其几何属性没有变化时，浏览器会跳过布局阶段，直接为该元素重新绘制（即重新进行“绘制”阶段），这个过程称为“重绘”。相比回流，重绘的开销较小。
